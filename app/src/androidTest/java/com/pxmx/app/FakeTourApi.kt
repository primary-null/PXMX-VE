...
class FakeTourApi : ProxmoxApi {
    ...
    override suspend fun applySdn(): PveResponse<String?> = PveResponse(data = "UPID:alpha:00003001:00000000:66D1B010:sdnreload::root@pam:")
    override suspend fun nodeSyslog(node: String, start: Int?, limit: Int?): PveResponse<List<Map<String, Any>>> = PveResponse(data = emptyList())
    ...
    override suspend fun setClusterFirewallOptions(enable: Int, digest: String?): PveResponse<String?> = PveResponse(data = null)
    ...
    override suspend fun setNodeFirewallOptions(node: String, enable: Int, digest: String?): PveResponse<String?> = PveResponse(data = null)
